...
spark = SparkSession.builder \
    ...
    .config("spark.hadoop.fs.s3a.bucket.faisalsbkt.aws.credentials.provider","org.apache.hadoop.fs.s3a.SimpleAWSCredentialsProvider") \
    .config("spark.hadoop.fs.s3a.bucket.faisalsbkt.access.key","bf49816e1eec4368a38b5dc9c57de9a2") \
    .config("spark.hadoop.fs.s3a.bucket.faisalsbkt.secret.key","4f86cd88400b6b1671abc5b1c757a6330eb06a76012ad19b") \
    .config("spark.hadoop.fs.s3a.path.style.access","true") \
    .config("spark.hadoop.fs.s3a.bucket.faisalsbkt.endpoint","s3.jp-tok.cloud-object-storage.appdomain.cloud") \
    .enableHiveSupport() \
    .getOrCreate()
...
# Run a command to check Java version used by the JVM
