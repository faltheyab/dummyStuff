...
spark.conf.set("spark.hadoop.fs.stocator.cos.impl", "com.ibm.stocator.fs.cos.COSV4APIClient")
...
while True:
    ...
    if (random_num % 2 == 0):
        read_write_app("ID_DATA_Example.csv","output_even_example5.csv")
    else:
        read_write_app("Employees.csv","output_odd_example5.csv")
